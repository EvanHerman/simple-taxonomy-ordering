...
This plugin is quite similar to [Simple Page Ordering](https://wordpress.org/plugins/simple-page-ordering/), but allows you to easily re-order taxonomies using drag and drop functionality.
